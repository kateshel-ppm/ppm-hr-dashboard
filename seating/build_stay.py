...
Кабинеты и ёмкости — как в «Рассадка — предложение», но Л2 на 6 мест
(гибрид): переговорная свободна, левое крыло 30 мест, правое 22.
...
# Л2 — 6 мест вместо 5: часть финансов в гибриде, столы можно делить
# (указание заказчика).
ROOMS = [("Л1", "левое", 2), ("Л2", "левое", 6), ("Л3", "левое", 11), ("Л4", "левое", 11),
...
PLAN = [
    ...
    # Л2 — Смелова, финансы и казначей ВЭД (шестое место за счёт гибрида).
    ("Л2", take_named("HR", {"Смелова Наталья"}) + take("Фин") + take("ВЭД")),
